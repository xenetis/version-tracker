...
class PrometheusPlugin(AbstractPlugin):
    ...
    def get_current_version(self):
        try:
            ...
            return self.normalize_version(data.get("data", {}).get("version", self.translations.get("unknown"))) if data else self.translations.get("error")
    ...
    def get_latest_version(self):
        ...
        try:
            ...
            if latest_version not in [self.translations.get("unknown"), self.translations.get("error")]: latest_version_cache["prometheus"] = latest_version
